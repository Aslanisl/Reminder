...
public class SectionsTasksArrayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SectionsTasksArrayAdapter(Context context, int sectionResourceId, int textResourceId,
